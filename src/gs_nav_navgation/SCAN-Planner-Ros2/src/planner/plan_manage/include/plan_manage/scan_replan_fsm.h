...
namespace scan_planner
{
  ...
  private:
    ...
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr execution_frozen_sub_;
    ...
    void executionFrozenCallback(const std_msgs::msg::Bool::ConstSharedPtr &msg);
